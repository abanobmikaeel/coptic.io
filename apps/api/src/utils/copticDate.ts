 ...
 * @param day - Gregorian day of month (1-31)
 ...
 * @returns Coptic year, month (1-13), and day (1-30)
 */
...
/**
 * Convert a JavaScript Date to Coptic calendar date
 *
 * @param gregorianDate - JavaScript Date object (uses local timezone)
 * @returns Object containing:
 *   - dateString: Formatted string like "Toba 21, 1742"
 *   - day: Day of month (1-30, or 1-6 for Nasie)
 *   - month: Month number (1-13)
 *   - year: Coptic year
 *   - monthString: Month name in English
 */
