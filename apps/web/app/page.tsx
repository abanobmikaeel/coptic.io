	...
	return (
		<main className="min-h-screen relative overflow-hidden">
			...
			<section className="relative pt-20 pb-8 px-6">
				<div className="max-w-4xl mx-auto text-center">
					...
					<p className="text-lg text-gray-600 dark:text-gray-300 max-w-lg mx-auto leading-relaxed">
						Daily scripture readings and feast day reminders from the Coptic Orthodox calendar,
			...
			<section className="relative px-6 pb-16">
				<div className="max-w-4xl mx-auto text-center">
					<p className="text-gray-500 dark:text-gray-400 text-sm mb-3">Prefer calendar sync?</p>
					<a
			...
			<footer className="relative border-t border-gray-200 dark:border-gray-800 py-8 px-6">
				<div className="max-w-4xl mx-auto flex items-center justify-center">
					<p className="text-gray-500 dark:text-gray-400 text-sm">Built for the Coptic community</p>
				</div>
			</footer>
		</main>
	)
