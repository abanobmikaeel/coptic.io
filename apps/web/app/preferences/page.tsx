					...
					<div className="max-w-md mx-auto">
						<Card>
							...
							<p className="text-gray-600 dark:text-gray-400 mb-6">
								To manage your email preferences, please use the link from any email we&apos;ve sent
								you, or subscribe to get started.
							</p>
							<Link
								href="/subscribe"
				...
				<div className="max-w-md mx-auto">
					<Card>
						...
						<p className="text-gray-600 dark:text-gray-400 mb-6">
							...
							<span className="font-medium text-gray-900 dark:text-white">{preferences.email}</span>
						</p>
