			...
			<Card>
				...
				<CardContent>
					<FormSelect
						...
						description={t('siteLanguageDescription')}
						options={[
			...
			<Card>
				...
				<CardContent>
					<div className="mb-1 p-4 rounded-xl bg-gray-50 dark:bg-gray-800/60 border border-gray-100 dark:border-gray-700">
						<p className="text-[10px] uppercase tracking-widest text-gray-400 dark:text-gray-500 mb-2.5 font-medium">
							{t('preview')}
						</p>
						<p
							className={[
								previewSize[prefs.size],
						...
						>
							Blessed are the pure in heart, for they shall see God. The Lord is my shepherd; I shall
							not want.
						</p>
					</div>
					<FormSelect
					...
					<button
						...
						className="flex items-center gap-1.5 mt-1 py-2 text-xs font-medium text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition-colors w-full"
					>
						<ChevronDownIcon
					...
					{advancedOpen && (
						<>
							...
							<FormSelect
								...
								name="spacing"
								label={t('lineSpacing')}
								description={t('lineSpacingDescription')}
								options={[
							...
							<FormSelect
								...
								name="wordSpacing"
								label={t('wordSpacing')}
								description={t('wordSpacingDescription')}
								options={[
							...
							<FormSelect
								...
								description={t('contentWidthDescription')}
								options={[
