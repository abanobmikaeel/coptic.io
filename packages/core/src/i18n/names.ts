...
const LITURGICAL_NAMES: Record<Exclude<NameLang, 'en'>, Record<string, string>> = {
	ar: {
		...
		// Feasts
		'Coptic New Year (Nayrouz)': 'رأس السنة القبطية (النيروز)',
		'Feast of the Cross': 'عيد الصليب',
		'Appearance of the Cross': 'عيد ظهور الصليب',
		'Advent Fast': 'صوم الميلاد',
		Kiahk: 'كيهك',
		'Nativity Paramoun': 'بارامون الميلاد',
		'Nativity Feast': 'عيد الميلاد',
		'Circumcision Feast': 'عيد الختان',
		'Theophany Paramoun': 'بارامون الغطاس',
	...
	es: {
		...
		// Feasts
		'Coptic New Year (Nayrouz)': 'Año Nuevo Copto (Nayrouz)',
		'Feast of the Cross': 'Fiesta de la Cruz',
		'Appearance of the Cross': 'Aparición de la Cruz',
		'Advent Fast': 'Ayuno de Adviento',
		Kiahk: 'Kiahk',
		'Nativity Paramoun': 'Paramón de la Natividad',
		'Nativity Feast': 'Fiesta de la Natividad',
		'Circumcision Feast': 'Fiesta de la Circuncisión',
		'Theophany Paramoun': 'Paramón de la Teofanía',
		...
		'St. Mary Feast (Commemoration of Her Assumption)':
			'Fiesta de Santa María (Conmemoración de su Asunción)',
	},
}
