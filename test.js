...
function getVerse(bookName, chapterNumber, verseNumberOrRange) {
    var BIBLE_API_PORT = 5000;
    var url = "http://localhost:" + BIBLE_API_PORT + "/api/get_verse/" + bookName + "/" + chapterNumber + "/" + verseNumberOrRange;
    return axios_1["default"].get(url);
}
// getVerse('genesis', 1, '2')
getVerse('Psalms', 132, '10-11').then(function (e) { return console.log(e.data); });
function getObjectsFromCSV() {
    return __awaiter(this, void 0, void 0, function () {
        var file, x;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, promises_1.readFile)('uniqueReadings.csv')];
                case 1:
                    file = _a.sent();
                    x = (0, sync_1["default"])(file, {
                        columns: [
                            'Day',
                            'VPsalm',
                            'VGospel',
